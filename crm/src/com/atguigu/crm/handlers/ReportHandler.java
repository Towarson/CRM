...
public class ReportHandler {
	...
	public String service(@RequestParam(value="pageNoStr",required=false) String pageNoStr,
		...
		Page<Map<String, Object>> page = reportService.getCustomerServiceReportPage(pageNoStr,parameters);
	...
	//客户构成分析
	@RequestMapping("/constitute/list")
	public String constitute(@RequestParam(value="pageNoStr",required=false) String pageNoStr,
			Map<String, Object> map,HttpServletRequest request) {
		
		//从请求request对象中获取参数的map集合
		Map<String, Object> parameters = WebUtils.getParametersStartingWith(request, "search_");
		
		if(parameters.get("EQS_type") == null) {
			parameters.put("EQS_type", "CUSTOMER_LEVEL");
		}
		...
		Page<Map<String, Object>> page = reportService.getCustomerConstitutePage(pageNoStr,parameters);
		
		map.put("page", page);
		
		return "report/constitute";
	}
